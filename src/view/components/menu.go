...
func Menu(
	props tuix.Props,
	onChange func(selectedItem string, index int),
	onFocusChange func(index int),
) tuix.Element {
	...
	menuItems := utils.Map(
		items[viewFloor:viewCeil],
		func(item string, index int) tuix.Element {
